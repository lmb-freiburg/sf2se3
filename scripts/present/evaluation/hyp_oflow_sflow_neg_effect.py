...
def main():
    ...
    #image_fpath_rel = "imgs/outlier/temple_2_23.png"
    image_text = ["optical flow", "approach", "approach", "approach"]  # approach ablation
    generate_type = "images"  # images table plot_bars
    #save_fpath = "/media/driveD/sflow2rigid3d/evaluation/hyp_oflow_sflow_neg_effect_ft3d_A_0000_0.png"
    #save_fpath = "/media/driveD/sflow2rigid3d/evaluation/hyp_oflow_sflow_neg_effect_sintel_temple_2_23.png"
