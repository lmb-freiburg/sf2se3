...
def main():
    ...
    # KITTI
    #runs_selected = [runs_selected[7], runs_selected[7], runs_selected[5]]
    # Sintel
    #runs_selected = [runs_selected[11], runs_selected[11], runs_selected[9]]
    # TUM RGBD
    #runs_selected = [runs_selected[19], runs_selected[19], runs_selected[17]]
    # Bonn RGBD
    ...
    #image_fpath_rel = "imgs/objs_labels_gt_vs_se3/000169_0.png"
    #image_fpath_rel = "imgs/objs_labels_gt_vs_se3/mountain_1_21.png"
    #image_fpath_rel = "imgs/objs_labels_gt_vs_se3/rgbd_dataset_freiburg3_walking_static_184.png"
    image_fpath_rel = "imgs/objs_labels_gt_vs_se3/A/0014_4.png"
    #image_fpath_rel = "imgs/objs_labels_gt_vs_se3/000169_0.png"
    image_text = ["ground truth", "approach", "approach"] # approach ablation
    ...
    #save_fpath = "/media/driveD/sflow2rigid3d/evaluation/fail_seg_freiburg3_walking_static_184.png"
    save_fpath = "/media/driveD/sflow2rigid3d/evaluation/fail_seg_no_object_ft3d_A_0014_4_v2.png"
    #save_fpath = "/media/driveD/sflow2rigid3d/evaluation/fail_seg_no_object_kitti_0169.png"
