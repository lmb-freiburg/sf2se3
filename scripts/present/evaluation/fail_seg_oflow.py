...
def main():
    ...
    # FT3D
    runs_selected = [runs_selected[3], runs_selected[3], runs_selected[1]]
    # Sintel
    ...
    image_fpath_rel = "imgs/objs_labels_gt_vs_se3/A/0014_1.png"
    image_fpath_rel = "imgs/objs_labels_gt_vs_se3/A/0014_4.png"
    image_fpath_rel = "imgs/objs_labels_gt_vs_se3/A/0038_2.png"
    image_fpath_rel = "imgs/objs_labels_gt_vs_se3/A/0042_0.png"
    image_fpath_rel = "imgs/objs_labels_gt_vs_se3/B/0008_3.png"
    image_fpath_rel = "imgs/objs_labels_gt_vs_se3/B/0012_1.png"
    image_fpath_rel = "imgs/objs_labels_gt_vs_se3/A/0000_0.png"

    image_fpath_rel = ["imgs/outlier/A/0000_0.png",
                       "imgs/objs_labels_gt_vs_se3/A/0000_0.png",
                       "imgs/objs_labels_gt_vs_se3/A/0000_0.png"]

    #image_fpath_rel = ["imgs/outlier/B/0003_2.png",
    #                   "imgs/objs_labels_gt_vs_se3/B/0003_2.png",
    #                   "imgs/objs_labels_gt_vs_se3/B/0003_2.png"]
    ...
    image_text = ["optical flow", "approach", "approach"]  # approach ablation
    ...
    save_fpath = "/media/driveD/sflow2rigid3d/evaluation/fail_seg_no_object_ft3d_A_0014_1.png"
    save_fpath = "/media/driveD/sflow2rigid3d/evaluation/fail_seg_no_object_ft3d_A_0014_4.png"
    save_fpath = "/media/driveD/sflow2rigid3d/evaluation/fail_seg_no_object_ft3d_A_0038_2.png"
    save_fpath = "/media/driveD/sflow2rigid3d/evaluation/fail_seg_no_object_ft3d_A_0042_0.png"
    save_fpath = "/media/driveD/sflow2rigid3d/evaluation/fail_seg_no_object_ft3d_B_0008_3.png"
    save_fpath = "/media/driveD/sflow2rigid3d/evaluation/fail_seg_no_object_ft3d_B_0012_1.png"
    save_fpath = "/media/driveD/sflow2rigid3d/evaluation/fail_seg_oflow_no_object_ft3d_A_0000_0.png"
    #save_fpath = "/media/driveD/sflow2rigid3d/evaluation/fail_seg_oflow_overseg_ft3d_B_0003_2.png"
