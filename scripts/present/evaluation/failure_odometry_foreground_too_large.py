...
def main():
    ...
    #image_fpath_rel = "imgs/objs_labels_gt_vs_se3/ambush_4_5.png"
    ...
    #save_fpath = "/media/driveD/sflow2rigid3d/evaluation/failure_odometry_foreground_sintel_ambush_4_5.png"
