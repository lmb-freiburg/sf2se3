...
# ids: FT3D: 0-2, KITTI: 3-5, Sintel: 6-8, FR2: 9-11, FR3: 12-14, Bonn: 15-17, KITTI-Test: 18-20
# 'rgbd_dataset_freiburg3_sitting_halfsphere*.png'
# '0014_1.png'
# x-start, y-start, x-width, y-width
"""
args = {
    "save_fname": "drpc_rigidmask_ft3d_A_0014_4.png",
    "run_imgs_sub_dir": "imgs/objs_labels_contours_gt_vs_se3/A", # A / B / C,
    "img_glob_pattern": '0014_4.png',
    "fps": 5,
    "runs_selected_ids": [2, 2, 0], # 3, 1]
    "runs_texts": ["ground truth", "SF2SE3 (ours.)", "RigidMask"],
    "runs_rois_crop" : [(10, 11, 942, 523), (972, 12, 942, 523), (972, 12, 942, 523)],
    "runs_rois_text" : [(15, 406, 35, 95), (15, 406, 35, 95), (15, 406, 35, 95)],
    "rois_frames" : [[317, 307, 186, 112], [557, 28, 378, 239]]
}
"""
"""
args = {
    "save_fname": "drpc_rigidmask_kitti_169.png",
    "run_imgs_sub_dir": "imgs/objs_labels_contours_gt_vs_se3", # A / B / C,
    "img_glob_pattern": '000169_0.png',
    "fps": 5,
    "runs_selected_ids": [5, 5, 3, ], # 3, 1]
    "runs_texts": ["ground truth", "SF2SE3 (ours.)", "RigidMask"],
    "runs_rois_crop": [(21, 19, 1194, 341), (1259, 20, 1194, 341), (1259, 20, 1194, 341)],
    #"runs_rois_text": [(26, 22, 41, 92), (26, 22, 41, 92), (26, 22, 41, 92)],
    "runs_rois_text": [(26, -22, 41, 92), (26, -22, 41, 92), (26, -22, 41, 92)],
    "rois_frames": [[520, 172, 81, 163], [709, 161, 70, 146], [962, 122, 75, 172]]
}
"""

args = {
    "save_fname": "drpc_rigidmask_raft3d_tum_fr3.png",
    "run_imgs_sub_dir": "imgs/sflow_objs_labels_contours_gt_vs_se3", # A / B / C,
    "img_glob_pattern": 'rgbd_dataset_freiburg3_walking_halfsphere_3.png',
    "fps": 5,
    "runs_selected_ids": [14, 12, 13], # 3, 1]
    "runs_texts": ["SF2SE3 (ours.)", "RigidMask", "RAFT-3D"],
    "runs_rois_crop" : [(665, 85, 605, 395), (665, 85, 605, 395), (665, 85, 605, 395)],
    "runs_rois_text" : [(12, 8, 43, 66), (12, 8, 43, 66), (12, 8, 43, 66)],
    "rois_frames" : []
}

"""
args = {
    "save_fname": "drpc_rigidmask_raft3d_ft3d_A_0000_0.png",
    "run_imgs_sub_dir": "imgs/sflow_objs_labels_contours_gt_vs_se3/A", # A / B / C,
    "img_glob_pattern": '0000_0.png',
    "fps": 5,
    "font_color": (20, 20, 20),
    "runs_selected_ids": [2, 0, 1], # 3, 1]
    "runs_texts": ["SF2SE3 (ours.)", "RigidMask", "RAFT-3D"],
    "runs_rois_crop" : [(10, 11, 942, 523), (972, 12, 942, 523), (972, 12, 942, 523), (972, 12, 942, 523)],
    "runs_rois_text" : [(610, 406, 35, 95), (705, 406, 35, 95), (705, 406, 35, 95), (605, 406, 35, 95)],
    "rois_frames" : []
}
"""
"""
args = {
    "save_fname": "drpc_rigidmask_raft3d_kitti_test_43.png",
    "run_imgs_sub_dir": "imgs/sflow_objs_labels_contours_gt_vs_se3", # A / B / C,
    "img_glob_pattern": '000043_0.png',
    "fps": 5,
    "font_color": (0, 0, 0),
    "runs_selected_ids": [20, 18, 19], # 3, 1]
    "runs_texts": ["SF2SE3 (ours.)", "RigidMask", "RAFT-3D"],
    "runs_rois_crop": [(1259, 20, 1194, 341), (1259, 20, 1194, 341), (1259, 20, 1194, 341)],
    "runs_rois_text": [(26, 22, 41, 92), (26, 22, 41, 92), (26, 22, 41, 92)],
    "rois_frames": [], #[[520, 172, 81, 163], [709, 161, 70, 146], [962, 122, 75, 172]]
}
"""
"""
args = {
    "save_fname": "drpc_rigidmask_raft3d_kitti_155.png",
    "run_imgs_sub_dir": "imgs/sflow_objs_labels_contours_gt_vs_se3", # A / B / C,
    "img_glob_pattern": '000155_0.png',
    "fps": 5,
    "font_color": (0, 0, 0),
    "runs_selected_ids": [5, 3, 4], # 3, 1]
    "runs_texts": ["SF2SE3 (ours.)", "RigidMask", "RAFT-3D"],
    "runs_rois_crop": [(1259, 20, 1194, 341), (1259, 20, 1194, 341), (1259, 20, 1194, 341)],
    "runs_rois_text": [(26, 22, 41, 92), (26, 22, 41, 92), (26, 22, 41, 92)],
    "rois_frames": [], #[[520, 172, 81, 163], [709, 161, 70, 146], [962, 122, 75, 172]]
...
"""
args = {
    "save_fname": "drpc_rigidmask_raft3d_kitti_137.png",
    "run_imgs_sub_dir": "imgs/sflow_objs_labels_contours_gt_vs_se3", # A / B / C,
    "img_glob_pattern": '000137_0.png',
    "fps": 5,
    "font_color": (20, 20, 20),
    "runs_selected_ids": [5, 3, 4], # 3, 1]
    "runs_texts": ["SF2SE3 (ours.)", "RigidMask", "RAFT-3D"],
...
"""
args = {
    "save_fname": "drpc_rigidmask_raft3d_ft3d_A_0014_4.png",
    "run_imgs_sub_dir": "imgs/sflow_objs_labels_contours_gt_vs_se3/A", # A / B / C,
    "img_glob_pattern": '0014_4.png',
    "fps": 5,
    "runs_selected_ids": [2, 2, 0, 1], # 3, 1]
    "runs_texts": ["ground truth", "SF2SE3 (ours.)", "RigidMask", "RAFT-3D"],
    "runs_rois_crop" : [(10, 11, 942, 523), (972, 12, 942, 523), (972, 12, 942, 523), (972, 12, 942, 523)],
    "runs_rois_text" : [(15, 406, 35, 95), (15, 406, 35, 95), (15, 406, 35, 95), (15, 406, 35, 95)],
    "rois_frames" : [[317, 307, 186, 112], [557, 28, 378, 239]]
}
"""
"""
...
def main(args):
    ...
    runs_selected = [
        ...
        "kitti_test_classic__22_02_2022__18_32_12",
        "kitti_test_classic__22_02_2022__18_32_12",
        "kitti_test_classic__22_02_2022__18_32_12"
    ]
    ...
    runs_selected = [
        ...
        #"kitti_train_classic__22_02_2022__17_47_43",
        "kitti_train_classic__21_02_2022__17_04_19",
    ...
    for i, img_fname in enumerate(imgs_fnames):
        ...
        cv2.imwrite(filename=save_fpath, img=img)
...
def select_roi_for_multiple_imgs(imgs_fpaths, rois_crops=None):
    ...
    for i, img_fpath in enumerate(imgs_fpaths):
        ...
        if i == 0:
            ...
            print(roi)
            first_img = draw_roi(first_img, roi)
