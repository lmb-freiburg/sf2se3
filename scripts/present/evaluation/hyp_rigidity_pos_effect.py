...
def main():
    ...
    # FT3D
    #runs_selected = [runs_selected[3], runs_selected[2], runs_selected[1]]
    # Sintel
    runs_selected = [runs_selected[11], runs_selected[10], runs_selected[9]]
    ...
    image_fpath_rel = "imgs/outlier/ambush_7_41.png"
    image_text = ["scene flow", "approach", "approach"]  # approach ablation
    ...
    save_fpath = "/media/driveD/sflow2rigid3d/evaluation/hyp_rigidity_pos_effect_sintel_ambush_7_41.png"
