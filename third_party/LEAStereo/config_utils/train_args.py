...
def obtain_train_args():
    ...
    parser.add_argument(
        "--testBatchSize", type=int, default=8, help="testing batch size"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--seed", type=int, default=2019, help="random seed to use. Default=123"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--stage", type=str, default="train", choices=["search", "train"]
    )
    parser.add_argument(
        "--dataset",
        type=str,
